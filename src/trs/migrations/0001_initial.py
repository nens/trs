...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="toegevoegd op"
                    ),
                ),
                (
                    "hours",
            ...
            options={"verbose_name": "boeking", "verbose_name_plural": "boekingen"},
        ),
        migrations.CreateModel(
            name="BudgetItem",
            fields=[
                ...
                (
                    "amount",
                    models.DecimalField(
                        help_text="Dit zijn kosten, dus een positief getal wordt van het projectbudget afgetrokken. (Dit is in sept 2014 veranderd!)",
                        decimal_places=2,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "number",
                    models.CharField(max_length=255, verbose_name="factuurnummer"),
                ),
                (
                    "description",
                    models.CharField(
                ...
                (
                    "vat",
                    models.DecimalField(
                        decimal_places=2, verbose_name="btw", max_digits=12, default=0
                    ),
                ),
                (
                    "payed",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "amount",
                    models.DecimalField(
                        help_text="Dit zijn kosten, dus een positief getal wordt van het projectbudget afgetrokken. Bedrag is ex btw.",
                        decimal_places=2,
                        verbose_name="bedrag exclusief",
                        max_digits=12,
                        default=0,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_management",
                    models.BooleanField(
                        help_text="Management can see everything, but doesn't get extra edit rights",
                ...
                (
                    "archived",
                    models.BooleanField(verbose_name="gearchiveerd", default=False),
                ),
                (
                    "cache_indicator",
                    models.IntegerField(verbose_name="cache indicator", default=0),
                ),
                (
                    "cache_indicator_person_change",
                    models.IntegerField(
                ...
                (
                    "last_modified",
                    models.DateTimeField(
                        auto_now=True, verbose_name="laatst gewijzigd"
                    ),
                ),
                (
                    "group",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        unique=True, max_length=255, verbose_name="projectcode"
                    ),
                ),
                (
                    "code_for_sorting",
                ...
                (
                    "internal",
                    models.BooleanField(verbose_name="intern project", default=False),
                ),
                (
                    "hidden",
                    models.BooleanField(
                        help_text="Zet dit standaard aan voor interne projecten, tenzij het een 'echt' project is waar uren voor staan. Afgeschermde projecten kan je andermans gegevens niet van zien. Goed voor ziekte enzo.",
                ...
                (
                    "hourless",
                    models.BooleanField(
                        help_text="Uren van dit project tellen niet mee voor de intern/extern verhouding en binnen/buiten budget. Gebruik dit voor verlof en zwangerschapsverlof.",
                ...
                (
                    "principal",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="opdrachtgever"
                    ),
                ),
                (
                    "contract_amount",
                ...
                (
                    "is_accepted",
                    models.BooleanField(
                        help_text="Project is goedgekeurd door PM en PL en zou qua team en budgetverdeling niet meer gewijzigd moeten worden.",
                ...
                (
                    "is_subsidized",
                    models.BooleanField(
                        help_text="Dit project zit in een subsidietraject. Dit veld wordt gebruikt voor filtering.",
                ...
                (
                    "remark",
                    models.TextField(blank=True, verbose_name="opmerkingen", null=True),
                ),
                (
                    "financial_remark",
                    models.TextField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(unique=True, max_length=255, verbose_name="titel"),
                ),
                (
                    "start_date",
                    models.DateField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "first_day",
                    models.DateField(
                        db_index=True, verbose_name="eerste maandag van de week"
                    ),
                ),
                (
                    "num_days_missing",
        ...
        migrations.AddField(
            ...
            name="end",
            field=models.ForeignKey(
                default=trs.models.this_year_week_pk,
                blank=True,
                to="trs.YearWeek",
