...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PersonChange.external_percentage'
        db.delete_column('trs_personchange', 'external_percentage')


    def backwards(self, orm):
        # Adding field 'PersonChange.external_percentage'
        db.add_column('trs_personchange', 'external_percentage',
    ...
    models = {
        ...
        'trs.budgetassignment': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['auth.User']", 'null': 'True'}),
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'budget_assignments'", 'to': "orm['trs.Project']", 'null': 'True'}),
        ...
        'trs.project': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '255'}),
            'end': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'ending_projects'", 'to': "orm['trs.YearWeek']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'project_leader': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'projects_i_lead'", 'to': "orm['trs.Person']", 'null': 'True'}),
            'project_manager': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'projects_i_manage'", 'to': "orm['trs.Person']", 'null': 'True'}),
            'remark': ('django.db.models.fields.TextField', [], {'blank': 'True', 'null': 'True'}),
            'start': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'starting_projects'", 'to': "orm['trs.YearWeek']", 'null': 'True'})
        },
        'trs.workassignment': {
