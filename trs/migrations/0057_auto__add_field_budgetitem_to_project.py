...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BudgetItem.to_project'
        db.add_column('trs_budgetitem', 'to_project',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, related_name='budget_transfers', blank=True, to=orm['trs.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BudgetItem.to_project'
        db.delete_column('trs_budgetitem', 'to_project_id')
    ...
    models = {
        ...
        'trs.budgetitem': {
            ...
            'to_project': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'budget_transfers'", 'blank': 'True', 'to': "orm['trs.Project']"})
        },
        'trs.group': {
        ...
        'trs.person': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '255'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'persons'", 'blank': 'True', 'to': "orm['trs.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'trs.project': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'projects'", 'blank': 'True', 'to': "orm['trs.Group']"}),
