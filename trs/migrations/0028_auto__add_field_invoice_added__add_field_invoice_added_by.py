...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.added'
        db.add_column('trs_invoice', 'added',
                      self.gf('django.db.models.fields.DateTimeField')(blank=True, default=datetime.datetime(2013, 12, 5, 0, 0), auto_now_add=True),
                      keep_default=False)

        # Adding field 'Invoice.added_by'
        db.add_column('trs_invoice', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['auth.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.added'
        db.delete_column('trs_invoice', 'added')

        # Deleting field 'Invoice.added_by'
        db.delete_column('trs_invoice', 'added_by_id')
