...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PersonChange'
        db.create_table('trs_personchange', (
            ...
            ('hours_per_week', self.gf('django.db.models.fields.DecimalField')(max_digits=8, blank=True, decimal_places=2, null=True)),
            ('target', self.gf('django.db.models.fields.DecimalField')(max_digits=8, blank=True, decimal_places=2, null=True)),
        ))
        db.send_create_signal('trs', ['PersonChange'])


    def backwards(self, orm):
        # Deleting model 'PersonChange'
        db.delete_table('trs_personchange')
