...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Group'
        db.create_table('trs_group', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.CharField')(blank=True, max_length=255)),
        ))
        db.send_create_signal('trs', ['Group'])

        # Adding field 'Person.group'
        db.add_column('trs_person', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='persons', to=orm['trs.Group'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.group'
        db.add_column('trs_project', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='projects', to=orm['trs.Group'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Group'
        db.delete_table('trs_group')

        # Deleting field 'Person.group'
        db.delete_column('trs_person', 'group_id')

        # Deleting field 'Project.group'
        db.delete_column('trs_project', 'group_id')
    ...
    models = {
        ...
        'trs.person': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'unique': 'True', 'blank': 'True', 'null': 'True'})
        },
        'trs.personchange': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'minimum_hourly_tariff': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'null': 'True', 'blank': 'True', 'decimal_places': '2'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'person_changes'", 'to': "orm['trs.Person']", 'null': 'True', 'blank': 'True'}),
            'standard_hourly_tariff': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'null': 'True', 'blank': 'True', 'decimal_places': '2'}),
