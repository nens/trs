...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('trs_budgetitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('added_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], blank=True, null=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trs.Project'], related_name='budget_items')),
            ('description', self.gf('django.db.models.fields.CharField')(blank=True, max_length=255)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=12, default=0, decimal_places=2)),
            ('is_reservation', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('trs', ['BudgetItem'])


    def backwards(self, orm):
        # Deleting model 'BudgetItem'
        db.delete_table('trs_budgetitem')
    ...
    models = {
        ...
        'trs.budgetassignment': {
            ...
            'budget': ('django.db.models.fields.DecimalField', [], {'blank': 'True', 'max_digits': '12', 'null': 'True', 'decimal_places': '2'}),
        ...
        'trs.person': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'blank': 'True', 'null': 'True', 'unique': 'True'})
        },
        'trs.personchange': {
