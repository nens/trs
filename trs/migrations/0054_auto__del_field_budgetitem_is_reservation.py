...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BudgetItem.is_reservation'
        db.delete_column('trs_budgetitem', 'is_reservation')


    def backwards(self, orm):
        # Adding field 'BudgetItem.is_reservation'
        db.add_column('trs_budgetitem', 'is_reservation',
    ...
    models = {
        ...
        'trs.person': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['trs.Group']", 'related_name': "'persons'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'trs.project': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['trs.Group']", 'related_name': "'projects'"}),
