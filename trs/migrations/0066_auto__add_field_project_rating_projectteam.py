...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.rating_projectteam'
        db.add_column('trs_project', 'rating_projectteam',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.rating_projectteam'
        db.delete_column('trs_project', 'rating_projectteam')
