...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('trs_project', 'archived',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('trs_project', 'archived')
    ...
    models = {
        ...
        'trs.booking': {
            ...
            'booked_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['trs.Person']", 'related_name': "'bookings'"}),
            'booked_on': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['trs.Project']", 'related_name': "'bookings'"}),
        ...
        'trs.budgetassignment': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['auth.User']"}),
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['trs.Project']", 'related_name': "'budget_assignments'"}),
            'budget': ('django.db.models.fields.DecimalField', [], {'blank': 'True', 'decimal_places': '2', 'max_digits': '12', 'null': 'True'}),
        ...
        'trs.person': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'unique': 'True', 'null': 'True', 'to': "orm['auth.User']"})
        },
        'trs.personchange': {
            ...
            'person': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['trs.Person']", 'related_name': "'person_changes'"}),
        ...
        'trs.project': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '255'}),
            'end': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['trs.YearWeek']", 'related_name': "'ending_projects'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'project_leader': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['trs.Person']", 'related_name': "'projects_i_lead'"}),
            'project_manager': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['trs.Person']", 'related_name': "'projects_i_manage'"}),
            'start': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['trs.YearWeek']", 'related_name': "'starting_projects'"})
        },
        'trs.workassignment': {
            'Meta': {'object_name': 'WorkAssignment'},
            'added': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['auth.User']"}),
            'assigned_on': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['trs.Project']", 'related_name': "'work_assignments'"}),
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['trs.Person']", 'related_name': "'work_assignments'"}),
