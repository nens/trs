...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonChange.person'
        db.add_column('trs_personchange', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, to=orm['trs.Person'], related_name='person_changes'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonChange.person'
        db.delete_column('trs_personchange', 'person_id')
