...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.is_subsidized'
        db.add_column('trs_project', 'is_subsidized',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.is_subsidized'
        db.delete_column('trs_project', 'is_subsidized')
    ...
    models = {
        ...
        'trs.budgetassignment': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['auth.User']", 'blank': 'True'}),
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'budget_assignments'", 'to': "orm['trs.Project']", 'blank': 'True'}),
