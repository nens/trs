...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.cache_indicator_person_change'
        db.add_column('trs_person', 'cache_indicator_person_change',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.cache_indicator_person_change'
        db.delete_column('trs_person', 'cache_indicator_person_change')
