...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.startup_meeting_done'
        db.add_column('trs_project', 'startup_meeting_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.startup_meeting_done'
        db.delete_column('trs_project', 'startup_meeting_done')
