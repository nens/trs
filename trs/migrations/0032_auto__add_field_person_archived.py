...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.archived'
        db.add_column('trs_person', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.archived'
        db.delete_column('trs_person', 'archived')
    ...
    models = {
        ...
        'trs.person': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['auth.User']", 'unique': 'True', 'blank': 'True'})
        },
        'trs.personchange': {
