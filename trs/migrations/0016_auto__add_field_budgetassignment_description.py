...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BudgetAssignment.description'
        db.add_column('trs_budgetassignment', 'description',
                      self.gf('django.db.models.fields.CharField')(blank=True, default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BudgetAssignment.description'
        db.delete_column('trs_budgetassignment', 'description')
    ...
    models = {
        ...
        'trs.budgetassignment': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['auth.User']", 'blank': 'True'}),
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'budget_assignments'", 'null': 'True', 'to': "orm['trs.Project']", 'blank': 'True'}),
