...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonChange.standard_hourly_tariff'
        db.add_column('trs_personchange', 'standard_hourly_tariff',
                      self.gf('django.db.models.fields.DecimalField')(null=True, blank=True, decimal_places=2, max_digits=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonChange.standard_hourly_tariff'
        db.delete_column('trs_personchange', 'standard_hourly_tariff')
    ...
    models = {
        ...
        'trs.budgetassignment': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['auth.User']"}),
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'budget_assignments'", 'null': 'True', 'blank': 'True', 'to': "orm['trs.Project']"}),
