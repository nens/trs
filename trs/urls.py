...
urlpatterns = patterns(
    ...
    url(r'^projects/$',
        ...
        name='trs.projects'),
    url(r'^projects/loss/$',
        views.ProjectsLossView.as_view(),
        name='trs.projects.loss'),
    url(r'^projects/csv/$',
    ...
    url(r'^projects/(?P<pk>\d+)/team/$',
        ...
        name='trs.project.team-old'),
    url(r'^projects/(?P<pk>\d+)/team2/$',
        views.TeamEditView2.as_view(),
